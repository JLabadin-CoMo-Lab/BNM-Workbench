...
write.table(final_geo, "res/location_list.txt", sep = "\t", row.names = FALSE, quote = FALSE)
...
write.table(movement, "res/movement_list_with_LID.txt", sep = "\t", row.names = FALSE, quote = FALSE)
