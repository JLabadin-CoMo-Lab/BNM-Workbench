...
raw <- read.table("res/contact_tracing_LID.txt",sep = '\t',header = TRUE)
...
human.ID <- read.table("res/Human_ID.txt",sep = '\t',header = TRUE)
...
write.table(bip.graph,"res/Human_Node.txt",sep = '\t',row.names = FALSE,col.names = TRUE,quote = FALSE)
